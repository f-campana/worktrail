...
- **Workstream**: A durable, user-meaningful unit of work that can span agent runs, repositories, branches, pull requests, and issues. It is the canonical organizing object; a thread is evidence for a workstream, not a synonym for one.
...
- **Correction**: A user-authored fact that overrides or refines derived organization. Corrections are explicit, auditable, and take precedence over heuristic grouping.
