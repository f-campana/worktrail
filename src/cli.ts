...
Usage:
  ...
  worktrail workstreams alias add WORKSTREAM_ID "alias" [--db PATH] [--json]
  ...
  worktrail threads unignore THREAD_UUID [--db PATH] [--json]
  worktrail eval queries.json [--db PATH] [--json] [--with-evidence]
